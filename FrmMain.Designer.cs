namespace TLMForwarder;
	...
	private void InitializeComponent()
	{
		...
		label3.Location = new Point(466, 53);
		label3.Name = "label3";
		...
		LblFrameNum.Location = new Point(580, 53);
		...
		// ChkBurst									test
		// 
		ChkBurst.AutoSize = true;
		ChkBurst.Location = new Point(449, 73);
		ChkBurst.Name = "ChkBurst";
		ChkBurst.Size = new Size(134, 19);
		ChkBurst.TabIndex = 15;
		ChkBurst.Text = "Burst Mode";
		ChkBurst.UseVisualStyleBackColor = true;
		ChkBurst.CheckedChanged += ChkBurst_CheckedChanged;
		// 
		// CmbSatName
		// 

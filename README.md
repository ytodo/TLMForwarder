...
//------------------------------------------------------------------------------------------
2025-01-25	ver 2.4.3	TLEソースを切り替えた時、再起動せずとも切替と同時に自動リスタートするように変更

2025-01-24	ver 2.4.2	SoundModemとの起ち上げ順位に影響されず衛星選択時ポートも含めリフレッシュ

2025-01-10	ver 2.4.1	バーストモードについては追々テストしながらの開発とし他を優先

2024-12-22	ver 2.4.0β	バーストデータに対応できないかテスト版としてアップグレード
